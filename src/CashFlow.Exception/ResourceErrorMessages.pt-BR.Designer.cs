...
namespace CashFlow.Exception {
    ...
    public class ResourceErrorMessages___Copy {
        ...
        /// </summary>
        public static string EXPENSES_IN_FUTURE {
            get {
                return ResourceManager.GetString("EXPENSES_IN_FUTURE", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Payment type {0} is not valid..
        /// </summary>
